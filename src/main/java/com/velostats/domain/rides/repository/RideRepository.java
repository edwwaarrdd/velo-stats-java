...
/**
 * The list endpoint hydrates entities and hands them to the response mapper, which is what the
...
public interface RideRepository extends JpaRepository<Ride, Long>, RideSummaryQueries {
    ...
    /**
     * The weather comes back in the same query rather than one lookup per ride, which is the only
